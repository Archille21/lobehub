export default {
  ...
  'messengerBanner.title': 'Talk to APM on your favorite messaging apps',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in APM.',
