export default {
  ...
  'builtins.lobe-task.goal.instruction': 'Describe the exact pass conditions and required evidence',
  ...
  'builtins.lobe-task.goal.script': 'Validation command or function',
