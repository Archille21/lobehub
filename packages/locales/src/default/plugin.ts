export default {
  ...
  'builtins.lobe-video-generation.apiName.generateVideo': 'Generate video',
  ...
  'builtins.lobe-video-generation.render.modelList.empty': 'No available video generation models',
  'builtins.lobe-video-generation.render.modelList.failed': 'Failed to load video models',
  'builtins.lobe-video-generation.render.modelList.models_one': '{{count}} model',
  'builtins.lobe-video-generation.render.modelList.models_other': '{{count}} models',
  'builtins.lobe-video-generation.render.modelList.noDescription': 'No description available',
  'builtins.lobe-video-generation.render.modelList.parameters': 'Parameters',
  'builtins.lobe-video-generation.render.modelList.showLess': 'Show less',
  'builtins.lobe-video-generation.render.modelList.showMore': 'Show {{count}} more',
  'builtins.lobe-video-generation.render.parameterList.empty':
    'No parameter schema is available for this model',
  'builtins.lobe-video-generation.render.parameterList.failed': 'Failed to load model parameters',
  'builtins.lobe-video-generation.render.parameterList.parameters_one': '{{count}} parameter',
  'builtins.lobe-video-generation.render.parameterList.parameters_other': '{{count}} parameters',
  'builtins.lobe-video-generation.render.retry': 'Retry',
  'builtins.lobe-video-generation.render.status.error': 'Failed',
  'builtins.lobe-video-generation.render.status.pending': 'Pending',
  'builtins.lobe-video-generation.render.status.processing': 'Generating',
  'builtins.lobe-video-generation.render.status.success': 'Completed',
  'builtins.lobe-video-generation.render.statusCheckFailed': 'Failed to check video status',
  'builtins.lobe-video-generation.title': 'Video Generation',
