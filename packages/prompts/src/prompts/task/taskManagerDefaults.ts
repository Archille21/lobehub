...
export const buildTaskManagerDefaultsBlock = ({
  ...
  return [
    ...
    `Default APM agent id: ${defaultAssigneeAgentId}`,
    'Use this id as assigneeAgentId when you decide a task should be assigned to the default APM assistant.',
    "Do not use it as a listTasks filter unless the user asks for APM's tasks.",
    '</task_manager_defaults>',
    '',
  ];
};
