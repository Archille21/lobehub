...
CREATE UNIQUE INDEX IF NOT EXISTS "user_connectors_user_agent_unique" ON "user_connectors" USING btree ("user_id","agent_id") WHERE "user_connectors"."agent_id" IS NOT NULL;--> statement-breakpoint
