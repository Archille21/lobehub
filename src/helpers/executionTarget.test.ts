...
describe('resolveExecutionTarget', () => {
  ...
  it('keeps a bound `local` as `sandbox` when no device routing is available ', () => {
...
describe('resolveExecutionPlan', () => {
  ...
  describe('sandbox — mutually exclusive with devices', () => {
    ...
    it('keeps a bound `local` as sandbox on a no-gateway backend ', () => {
